...
<!-- Mirrored from javedansari4122.000webhostapp.com/c_functions.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2020 09:39:16 GMT -->
		...
		$(document).ready(function() {
			...
			$(".buttonclass").click(function() {
				...
				var idd=$(this).attr("id");
			    	...
			    	$('#1'+idd).load("load-programs.html", {idfetch: idd
