...
<!-- Mirrored from javedansari4122.000webhostapp.com/query.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2020 09:39:08 GMT -->
...
<nav>
	...
	<div class="queryContainer">
		<form action = "#" method = "GET">
			...
			<table>
				<tr>
					<td><input type="text" placeholder="Name" name="username" size="22" required></td>	
				</tr>
				<tr>
					<td> </td>
				</tr>
				...
				<tr>
					<td><textarea  placeholder='Query/Feedback' name='userquery' rows='9' cols='35' required></textarea></td>
				</tr>
			</table>
			<br>
